...
public class Student extends Person {
	...
	public static class StudentGenerator {
		private static String[] names = {"Petar", "Anton", "Tony", "Anelia", "Dima", "Alice"};
		private static String[] specialities = {"Informatics", "STD", "BIT", "Matematika"};
		private static String[] universities = {"PU", "SU", "SU", "UHT"};
